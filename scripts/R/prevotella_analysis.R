...
ggsave("figures/prevotella/lm_viz.png")
...
plot_res$plot + 
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5))
ggsave("figures/prevotella/lm_viz_two_phy.png")
...
plot_res$plot + 
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5))
ggsave("figures/prevotella/lm_viz_labeled.png")
...
ggtree(phylogenomic_num_mid) + geom_tiplab(size = 2) + 
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave("figures/prevotella/phylogenomic_tree.png")
# BacA gene tree 
...
ggtree(BacA_num_mid) + geom_tiplab(size = 2) + 
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave("figures/prevotella/BacA_tree.png")
# DMRL_synthase
...
ggtree(DMRL_synthase_num_mid) + geom_tiplab(size = 2) + 
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave("figures/prevotella/DMRL_synthase.png")
# GTP_cyclohydroI 
...
ggtree(GTP_cyclohydroI_num_mid) + geom_tiplab(size = 2) + 
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave("figures/prevotella/GTP_cyclohydroI.png")
...
ggsave("figures/prevotella/gene_tree_support.png")
...
plot_support(phylo_bs, boot, color_branch = TRUE, 
             ...
             support_type = "boot")
ggsave("figures/prevotella/bootstrap_support.png")
